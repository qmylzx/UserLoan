        ...
        var info = {
            ...
            dialog: function (args) {
                ...
                if (opt.type == "image") {
                    ...
                    dialogHtml = '<div id=' + UUID + ' class="dialog animated zoomIn" style="width:' + width + 'px;top:' + (document.documentElement.clientHeight - opt.height) / 2 + 'px;left:' + (document.documentElement.clientWidth - width) / 2 + 'px;height:' + opt.height + 'px;">';
                    ...
                    if (isBackground) {
                        ...
                        dialogHtml += '<div id="dialog-content-' + UUID + '" class="dialog-content" style="height:' + (opt.height - 80) + 'px;overflow-y:hidden;">'
                    }
                    ...
                    $("#" + inputId).change(function () {
                        ...
                        if (dataType == "base64") {
                            ...
                            $.ajax({
                                ...
                                error: function () {
                                    info.optTip({content: "上传失败，可能跨域了", type: "error"})
                                }
                            })
                        }
                    })
